...
#else
uint8_t WIZ_MAC[6]     = {0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED}; //MAC Address
#endif
...
//#define TEST_LPB_UDP
...
#ifdef TEST_RA
		// Address_Auto_Config_RA
    	printf("\r\n\r\n");
		printf("%c is Address_Auto_Config_RA TEST!!\r\n", uart_menu);
		#if 1
        MO_flag = Address_Auto_Config_RA(0, data_buf, sizeof(data_buf));
		#else
        ...
        if(MO_flag == SLAAC_DHCP6)
		{
        	// Address_Auto_Config_Stateless_DHCP
			printf("\r\n\r\n");
		...
		{
        	// Address_Auto_Config_Statefull_DHCP
			printf("\r\n\r\n");
